...
const FilterSidebar = ({ filters, onFilterChange, onClearAll, isVisible, onClose }) => {
  ...
  const brands = [
    'Fresh Valley', 'Organic Farm', 'Green Choice', 'Nature\'s Best',
    'Farm Fresh', 'Pure Harvest', 'Healthy Living', 'Garden Select'
  ];
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed lg:static top-0 right-0 h-full w-80 lg:w-full bg-surface border-l lg:border-l-0 lg:border-r border-border z-modal lg:z-auto
      ...
      `}>
        <div className="p-4 lg:p-0">
          ...
          <div className="flex items-center justify-between mb-4 lg:hidden">
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-border-light rounded-button transition-smooth"
            >
              <Icon name="X" size={20} />
            </button>
          </div>
